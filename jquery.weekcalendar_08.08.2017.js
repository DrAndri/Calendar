      ...
      _renderCalendar : function() {
         ...
         if (options.buttons) {
            calendarNavHtml = "<div class=\"wc-nav\">\
                    <button class=\"wc-todayBtn btn ui-state-default ui-corner-all\">" + options.buttonText.today + "</button>\
                    <button class=\"wc-prev btn ui-state-default ui-corner-all\">" + options.buttonText.lastWeek + "</button>\
                    <button class=\"wc-next btn ui-state-default ui-corner-all\">" + options.buttonText.nextWeek + "</button>\
                    </div>";
